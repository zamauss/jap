...
class ConfiguracionController extends Controller
{
	...
	{
		echo CHtml::tag('option',array(),CHtml::encode('Seleccione un Configuracion'),true);
		if(Yii::app()->request->isAjaxRequest  )
		{
			...
			{
				if( $relacion[0]==Configuracion::BELONGS_TO && isset($_POST[$relacion[2]]) && !empty($_POST[$relacion[2]]) )
				{
			...
			if($bandera)
				$data=CHtml::listData(Configuracion::model()->findAll($criteria), 'id', 'nombre');
			else
				$data=array();

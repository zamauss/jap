...
class EstatusController extends Controller
{
	...
	{
		echo CHtml::tag('option',array(),CHtml::encode('Seleccione un Estatus'),true);
		if(Yii::app()->request->isAjaxRequest  )
		{
			...
			{
				if( $relacion[0]==Estatus::BELONGS_TO && isset($_POST[$relacion[2]]) && !empty($_POST[$relacion[2]]) )
				{
			...
			if($bandera)
				$data=CHtml::listData(Estatus::model()->findAll($criteria), 'id', 'nombre');
			else
				$data=array();

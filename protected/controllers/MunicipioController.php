...
class MunicipioController extends Controller
{
	...
	{
		echo CHtml::tag('option',array(),CHtml::encode('Seleccione un Municipio'),true);
		if(Yii::app()->request->isAjaxRequest  )
		{
			...
			{
				if( $relacion[0]==Municipio::BELONGS_TO && isset($_POST[$relacion[2]]) && !empty($_POST[$relacion[2]]) )
				{
			...
			if($bandera)
				$data=CHtml::listData(Municipio::model()->findAll($criteria), 'id', 'nombre');
			else
				$data=array();

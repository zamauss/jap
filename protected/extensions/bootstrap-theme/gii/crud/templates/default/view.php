...
echo "\$this->pageCaption='Ver '.$label.' #'.\$model->{$this->tableSchema->primaryKey};
...
$this->menu=array(
	...
	array('label'=>'Actualizar '. <?php echo $label; ?>, 'url'=>array('update', 'id'=>$model-><?php echo $this->tableSchema->primaryKey; ?>)),
	array('label'=>'Eliminar '. <?php echo $label; ?>, 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model-><?php echo $this->tableSchema->primaryKey; ?>),'confirm'=>'¿Estas seguro que quieres eliminar este elemento?')),

<?php
$this->pageCaption='Administrar '.IngresoPorCuotasdeRecuperacion::classNameLabel();
$this->pageTitle=Yii::app()->name . ' - ' . $this->pageCaption;
$this->pageDescription='Administrar '.IngresoPorCuotasdeRecuperacion::classNameLabel();

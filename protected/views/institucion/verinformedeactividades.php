...
<div class="row">
	...
	<div class="span6">
		<table class="table table-striped table-bordered">
			...
			<tfoot>
				<tr>
					<td><strong><?php echo 'Total de personas'?></strong></td>
					<td style="text-align:center;">
						<?php 
							$totalHorasVoluntarias 	= 	$info['numeroPersonasNomina'] +
														$info['numeroPersonasAsimilables'] +
														$info['numeroPersonasProfesionales'] +
														$info['numeroPersonasVoluntarias'] +
														$info['numeroPersonasPrestadoresSS'];
							echo $totalHorasVoluntarias;
						?>
					</td>
				</tr>
...
<div class="row">
	<div class="span4 offset8">
		<div class="alert alert-success">		  
			<h5 style="text-align:right">Total de ingreso
				<?php 
				...
				<tr>
					...
					<td style="text-align:center;">
						<?php 
							...
							echo '<span class="label label-success" style="font-size:10pt">' . $totalHorasVoluntarias . '</span>';
						?>
					</td>
				</tr>
			</tfoot>
